            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        //Navigation.findNavController(view).navigate(R.id.action_gameFragment_to_gameWonFragment) If u don't use Safe Arguments
                    ...
                    //Navigation.findNavController(view).navigate(R.id.action_gameFragment_to_gameOverFragment) If u don't use safe arguments
